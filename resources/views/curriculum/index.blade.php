        ...
        <x-slot name="content">
            ...
            <div class="container px-5 py-6 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div class="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-1 md:mt-0">
                    <button class="text-white bg-paleta-primario border-2 border-paleta-cuaternario py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg mb-2">{{ __('Contacto directo') }}</button>

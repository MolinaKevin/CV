<div class="flex items-center h-auto lg:h-full flex-wrap mx-auto my-16 lg:my-32">
	...
	<div id="profile" class="w-full lg:w-2/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-paleta-primario  mx-2 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
            ...
            <div class="mt-4 text-sm text-paleta-secundario max-h-40 text-justify pr-5 overflow-y-auto scrollbar-thin scrollbar-thumb-paleta-quinario scrollbar-track-paleta-primario overflow-y-scroll scrollbar-thumb-rounded">
                <p class="mb-3">{{ __('Si estás acá probablemente estés pensando en contratarme. Me veo obligado a advertirte que disfruto trabajar con autonomía, criterio y compromiso: entender el problema de fondo, proponer alternativas y hacerme responsable de llevar una solución adelante.') }}</p>
                <p class="mb-3">{{ __('Soy una persona comprometida, que se ha embarcado en diferentes travesías y que se esfuerza por encontrar las mejores soluciones a los problemas que se le presentan, tanto en la profesión como en el resto de la vida. Soy apasionado y leal; me gusta aprender y no le tengo miedo a ninguna tecnología.') }}</p>
                <p class="mb-3">{{ __('A lo largo de mi carrera me he topado con problemas tan heterogéneos que conozco muchos caminos y posibles soluciones. También me gusta compartir mi experiencia y que haya un objetivo o fin claro al momento de resolver cuestiones.') }}</p>
                <p class="mb-3">{{ __('La experiencia acumulada en proyectos y contextos diversos me permite participar en discusiones técnicas, aportar perspectiva y colaborar en la toma de decisiones. Me expreso con claridad y suelo aportar una visión global de las problemáticas.') }}</p>
                <p>{{ __('Por cualquier duda o cuestión, no dudes en contactarme con las herramientas de acá abajo y podemos charlarlo en persona; soy un tipo afable :).') }}</p>
            </div>
			<div class="pt-4 pb-8">
			...
			<div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                ...
                <a class="link" href="https://wa.me/4917624686820" aria-label="WhatsApp">

<div class="flex items-center h-auto lg:h-full flex-wrap mx-auto my-32 lg:my-32">
	...
	<!--Main Col-->
	<div id="profile" class="w-full lg:w-2/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-2 lg:mx-0">


		<div class="p-4 md:p-12 text-center lg:text-left">
			<!-- Image for mobile view-->
			<div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style="background-image: url('https://previews.123rf.com/images/peshkov/peshkov1905/peshkov190500168/121955275-creative-glowing-circuit-coding-background-programming-and-science-concept-3d-rendering.jpg')"></div>

			<h1 class="text-3xl font-bold pt-8 lg:pt-0">Kevin Molina</h1>
			...
			<p class="pt-8 text-sm">Soy un programador autodidacta. Empece a los 12 años y con aun con 28 sigo en el ambiente. Soy un fanatico empedernido de experimentar y no le tengo miedo a ningun tipo de tecnolog&iacute;a.</p>

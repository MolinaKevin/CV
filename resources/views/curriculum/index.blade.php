    ...
    <x-dialog-modal wire:model="modal" maxWidth="7xl">
        ...
        <x-slot name="content">
            ...
            <div class="container px-5 py-6 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div class="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-2 md:mt-0">
                    <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg mb-2">Button</button>

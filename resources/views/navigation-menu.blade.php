<div x-data="{ open: false }" class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <div class="mt-2 flex items-center sm:hidden">
        <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-paleta-terciario hover:text-paleta-cuaternario hover:bg-paleta-quinario focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">

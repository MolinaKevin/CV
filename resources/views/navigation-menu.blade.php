<div x-data="{ open: false }" class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <div class="mt-2 flex items-center sm:hidden">
        <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-paleta-cuaternario hover:text-paleta-primario hover:bg-paleta-cuaternario focus:outline-none focus:bg-paleta-cuaternario focus:text-paleta-primario transition duration-150 ease-in-out">
